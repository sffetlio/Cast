...
public class MusicManager implements Disposable {
	 ...
	 */
	public enum CastMusic {
		MENU("music/menu.ogg"), LEVEL("music/level.ogg");

		private String fileName;
		private Music musicResource;

		private CastMusic(String fileName) {
	 ...
	 */
	private CastMusic musicBeingPlayed;
	 ...
	 */
	public void play(CastMusic music) {
		...
		// do some logging
		Gdx.app.log(Cast.LOG, "Playing music: " + music.name());
	...
	public void stop() {
		if (musicBeingPlayed != null) {
			Gdx.app.log(Cast.LOG, "Stopping current music");
	...
	public void setVolume(float volume) {
		Gdx.app.log(Cast.LOG, "Adjusting music volume to: " + volume);
	 ...
	 */
	public void dispose() {
		Gdx.app.log(Cast.LOG, "Disposing music manager");
		stop();
	}
}
